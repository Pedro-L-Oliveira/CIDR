...
public class App {
    ...
    private static NetworkAddress result = new NetworkAddress(null);
    ...
    public static void fourthQuestion() throws Exception {
        ...
        while (aux != "*") {
            ...
            if ((addresses.get(addresses.size() - 1).ip != null && addresses.get(addresses.size() - 1).mask != null) 
                || addresses.get(addresses.size() - 1).ip.split("\\.").length != 4)
